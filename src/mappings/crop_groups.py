...
home_grown_straw_feed_proportion=0.2 #parameter to reduce DM yield of home grown straw feeds to account for the fact that some of the straw is not fed to animals but is left on the field or used for other purposes. This is a rough estimate and can be adjusted based on more specific data if available.
...
DM_yield={
    ...
    'Bread milling winter wheat - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    ...
    'Feed spring wheat - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Feed wheat (all) - Grain_hg': 0.88,
    'Feed wheat (all) - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Feed winter barley - Grain_hg': 0.88,
    'Feed winter barley - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Feed winter wheat - Grain_hg': 0.88,
    'Feed winter wheat - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Field beans': 0.88,
    'Field beans (all) - Pulse_hg': 0.88,
    'Field beans (all) - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Fishmeal': 0.90,
    ...
    'Malting spring barley (all) - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Malting winter barley - Grain_hg': 0.88,
    'Malting winter barley - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Methionine': 1.0,
    'Milk powder': 0.90,
    'Milling wheat (all) - Grain_hg': 0.88,
    'Milling wheat (all) - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Minerals and Vitamins': 1.0,
    'Minor cereals - Grain_hg': 0.88,
    'Minor cereals - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Molasses - beet': 0.90,
    'Molasses - cane': 0.90,
    'Monocalcium phosphate': 1.0,
    'Oats (grain)': 0.88,
    'Oilseed rape (all) - Oilseed_hg': 0.88,
    'Oilseed rape (all) - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    ...
    'Soft milling winter wheat - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Soya Bean oil': 1.0,
    'Soya hulls': 0.90,
    ...
    'Spring brewing malting barley - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Spring distilling malting barley - Grain_hg': 0.88,
    'Spring distilling malting barley - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Spring feed barley - Grain_hg': 0.88,
    'Spring feed barley - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Spring field beans - Pulse_hg': 0.88,
    'Spring oats - Grain_hg': 0.88,
    'Spring oats - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Spring peas - Pulse_hg': 0.88,
    'Spring peas - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Straw (barley)': 0.85,
    'Straw (oats)': 0.85,
    'Straw (wheat)': 0.85,
    ...
    'Winter field beans - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Winter oats  - Grain_hg': 0.88,
    'Winter oats  - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Winter oilseed rape - Oilseed_hg': 0.88,
    'Winter oilseed rape - Straw_hg': 0.85*home_grown_straw_feed_proportion,
    'Winter rye - Grain_hg': 0.88,
    'Winter rye - Straw_hg': 0.85*home_grown_straw_feed_proportion
}
